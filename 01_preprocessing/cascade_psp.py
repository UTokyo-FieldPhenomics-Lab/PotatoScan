...
class Refiner:
    def __init__(self, device='cpu', model_path=None):
        ...
        # model_path = os.path.join(model_folder, 'cascade_psp')
        ...
        # cite: https://github.com/CSAILVision/places365/issues/25#issuecomment-333871990
        # model_dict = torch.load(model_path, map_location={'cuda': device}, pickle_module=pickle)
