...
class ParameterPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._spin_icp_threshold.setRange(0.001, 0.01)
        self._spin_icp_threshold.setSingleStep(0.001)
        self._spin_icp_threshold.setDecimals(3)
        ...
        self._spin_icp_iter.setRange(0, 50)
        self._spin_icp_iter.setSingleStep(5)
